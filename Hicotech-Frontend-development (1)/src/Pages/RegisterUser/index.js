...
import jsonFile  from '../CoachDashboard/Content/MyPlayers/palyers.json'
const { Option } = Select;

const RPlayer = (props, { location }) => {
  const { invi } = props;
    ...
    <div className="register">
      ...
      >
        ...
        <div className="logo-center">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbVPefkzg0_cQXk3M5OsAzjLiXbFemRzZvCA&usqp=CAU"
            height={130}
            width={130}
            alt=""
          />
